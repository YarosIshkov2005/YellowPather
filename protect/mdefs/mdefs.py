...
class MDEFSManager:
    ...
    def __init__(self, root, app_gui, app_state, app_perms, commands, 
        perms_state, path_manager, search, system, select_state, 
        select_position, app_render) -> None:
            self.root = root
