...
# RU 🇷🇺:
## YellowPather версия 1.0.3 "Yellow Brick Road"
...
> архитектура: класс ImportManager заменён на фабрику зависимостей.

> настройки: добавлена проверка расширений при создании папок (не работает на собственных расширениях).

> рекурсивный поиск: добавлена возможность отключения защиты для системных файлов.
...
# EN 🇬🇧:
## YellowPather version 1.0.3 "The Yellow Brick Road"
...
> architecture: The ImportManager class has been replaced with a dependency factory.

> settings: Added support for checking extensions when creating folders (does not work with custom extensions).

> recursive search: Added the ability to disable protection for system files.
