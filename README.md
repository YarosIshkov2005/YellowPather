...
> архитектура: улучшена навигация при переходе (корректно сохраняется история при переходах), исправлена проблема со вставкой имени объекта, и т.д.

> настройки: улучшена графика и дизайн интерфейса, работа кнопок Create, Delete, Rename в настройках.
...
*   📱 Android (прекратил поддержку начиная с версии 1.0.5)
...
* v1.0.5: устранена проблема со вставкой имени объекта при переходе в новую папку. 
...
> architecture: improved navigation when switching, fixed an issue with inserting an object name, etc.

> settings: improved graphics and the functionality of the Create, Delete, and Rename buttons.
...
* v1.0.5: Fixed an issue with inserting the object name when moving to a new folder.
