...
# RU 🇷🇺:
## YellowPather версия 1.0.2 "Yellow Brick Road"
...
# EN 🇬🇧:
## YellowPather version 1.0.2 "The Yellow Brick Road"
...
> settings: added sorting by name, date, size for each item in the list.
...
> **Note:** Files are available for superficial viewing only. Opening/modifying files is blocked by default in YellowPather to protect system resources from external interference. This protection applies to all search types.
